...
* Para hacer el *parse* podemos: 
	...
	1. Hacerlo a patita, haciendo *cast* y manejando los *nil*.<br>
	2. Usando *SwiftyJSON* y accediendo a los *atributos* a través de *clave:valor*<br>
	3. Pasando a el *response* a objetos, auxiliados de *pods* como *ObjectMapper* u otros.<br>
